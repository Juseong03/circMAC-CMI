#!/usr/bin/env python3
"""
fig7_encoder_umap_combined.py

Generates UMAP embedding figures for encoder comparison.

Output (per group):
  fig7_umap_encoder_main.{pdf,png}   — circCDYL2, circHUWE1, circMAPK1
  fig7_umap_encoder_supp.{pdf,png}   — circAPP, circ17q21.31, circNFIB
...
# =============================================================================
# Models (cache_key, display_label, pred_col)
# =============================================================================
MODELS = [
    ("LSTM",        "LSTM",        "pred_lstm"),
...
def main():
    make_figure(MAIN_CASES, MODELS,
                "Encoder comparison  |  Main cases",
                "fig7_umap_encoder_main")
    make_figure(SUPP_CASES, MODELS,
                "Encoder comparison  |  Supplementary cases",
                "fig7_umap_encoder_supp")
