#!/bin/bash
#===============================================================================
# Exp2 v4-A: No PT baseline + MLM + NTP
# → 새 df_pretrain 기준 재실행 (prefix: exp2v4)
# Usage: ./scripts/final/exp2_v4_a.sh [GPU_ID]
#===============================================================================
set -e
...
echo "=== Exp2 v4-A: No PT + MLM + NTP (GPU $GPU) ==="
...
echo "--- [1/3] No Pretraining (baseline) ---"
...
echo "=== v4-A Complete: $RAN ran, $SKIPPED skipped / $TOTAL total ==="
