#!/bin/bash
#===============================================================================
# Exp2 v3-A: No PT + MLM + NTP  → Server1 GPU0
# Usage: ./scripts/final/exp2_v3_a.sh [GPU_ID]
#===============================================================================
set -e
...
echo "=== Exp2 v3-A: No PT + MLM + NTP (GPU $GPU) ==="
...
echo "=== v3-A Complete: $RAN ran, $SKIPPED skipped / $TOTAL total ==="
