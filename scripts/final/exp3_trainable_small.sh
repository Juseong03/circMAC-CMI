#!/bin/bash
# Exp3: Trainable RNABERT + RNAErnie (bs=32, lighter models)
# Usage: ./scripts/final/exp3_trainable_small.sh [GPU_ID]
set -e

GPU=${1:-0}
SEEDS=(1 2 3)
TASK="sites"
D_MODEL=128; LR=1e-4; EPOCHS=150; EARLYSTOP=20; BS=32; NUM_WORKERS=4
declare -A MAX_LENS=( ["rnabert"]=440 ["rnaernie"]=510 )

mkdir -p logs/exp3 saved_models
TOTAL=0; SKIPPED=0; RAN=0

echo "=== Exp3 Trainable: RNABERT + RNAErnie ==="
