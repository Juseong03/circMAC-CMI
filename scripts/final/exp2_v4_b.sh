#!/bin/bash
#===============================================================================
# Exp2 v4-B: SSP + Pairing + CPCL
# → 새 df_pretrain 기준 재실행 (prefix: exp2v4)
# Usage: ./scripts/final/exp2_v4_b.sh [GPU_ID]
#===============================================================================
set -e
...
echo "=== Exp2 v4-B: SSP + Pairing + CPCL (GPU $GPU) ==="
...
echo "=== v4-B Complete: $RAN ran, $SKIPPED skipped / $TOTAL total ==="
