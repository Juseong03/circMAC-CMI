#!/bin/bash
#===============================================================================
# Exp2 v3-B: SSP + Pairing + CPCL  → Server1 GPU1
# Usage: ./scripts/final/exp2_v3_b.sh [GPU_ID]
#===============================================================================
set -e
...
echo "=== Exp2 v3-B: SSP + Pairing + CPCL (GPU $GPU) ==="
...
echo "=== v3-B Complete: $RAN ran, $SKIPPED skipped / $TOTAL total ==="
