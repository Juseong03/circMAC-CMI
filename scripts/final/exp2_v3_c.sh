#!/bin/bash
#===============================================================================
# Exp2 v3-C: MLM+NTP + All combined  → Server2 GPU0
# Usage: ./scripts/final/exp2_v3_c.sh [GPU_ID]
#===============================================================================
set -e
...
echo "=== Exp2 v3-C: MLM+NTP + All Combined (GPU $GPU) ==="
...
echo "--- [2/2] All Combined (MLM+NTP+SSP+Pair+CPCL) ---"
...
echo "=== v3-C Complete: $RAN ran, $SKIPPED skipped / $TOTAL total ==="
