#!/bin/bash
#===============================================================================
# Phase 1 — GPU 0: Pretrain v2_ptm_mlm_cpcl  (--mlm --cpcl)
#
# Run in PARALLEL with phase1_g1_pt.sh and phase1_g2_pt.sh.
# After all 3 finish, run phase2_g{0,1,2}_ft.sh.
#
# Usage: ./scripts/v2_pt_split/phase1_g0_pt.sh [GPU_ID]
#===============================================================================
set -e
...
echo "  Now run: ./scripts/v2_pt_split/phase2_g0_ft.sh $GPU"
