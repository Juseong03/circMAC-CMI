#!/bin/bash
#===============================================================================
# Phase 2 — GPU 0: Finetune seed=1 for all 3 new PT experiments
#
# Requires Phase 1 to be complete (all pretrained models must exist).
#
# Experiments:
#   v2_pt_mlm_cpcl_s1     ← v2_ptm_mlm_cpcl/42/pretrain/model.pth
#   v2_pt_pairing_s1      ← v2_ptm_pairing/42/pretrain/model.pth
#   v2_pt_mlm_cpcl_ssp_s1 ← v2_ptm_mlm_cpcl_ssp/42/pretrain/model.pth
#
# Usage: ./scripts/v2_pt_split/phase2_g0_ft.sh [GPU_ID]
#===============================================================================
set -e
...
run_ft() {
    local EXP_KEY=$1   # e.g. mlm_cpcl
    local PT_EXP=$2    # e.g. v2_ptm_mlm_cpcl
