#!/bin/bash
#===============================================================================
# Missing Experiments — Server2 GPU 0
#
# EXP2: v2_pt_bsj  (MLM + BSJ-focused MLM × 3 seeds)
#   Pretrain: v2_ptm_bsj  (--mlm --bsj_mlm, seed=42)
#   Finetune: v2_pt_bsj_s1, _s2, _s3
#
# Usage: ./scripts/v2_missing/run_missing_s2g0.sh [GPU_ID]
#===============================================================================
set -e
...
echo "========================================"
echo "  Missing Experiments — Server2 GPU $GPU"
echo "  EXP2: v2_pt_bsj  (MLM + BSJ-focused MLM)"
...
# ══ v2_pt_bsj: MLM + BSJ-focused MLM ════════════════════════════════════════
echo ""
echo "━━━ v2_pt_bsj: MLM + Back-Splice Junction focused MLM ━━━"
run_pretrain "bsj" --mlm --bsj_mlm
PT_PATH="saved_models/circmac/v2_ptm_bsj/${PT_SEED}/pretrain/model.pth"
if [ -f "$PT_PATH" ]; then
    run_finetune "bsj" "$PT_PATH"
else
