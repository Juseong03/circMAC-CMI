#!/bin/bash
#===============================================================================
# GPU 1 — v2_pt_mlm_cpcl  (MLM + CPCL pretrain → finetune × 3 seeds)
#
# Pretrain: v2_ptm_mlm_cpcl  (--mlm --cpcl, seed=42)
# Finetune: v2_pt_mlm_cpcl_s1, _s2, _s3
#
# 의의: CPCL 단독(v2_pt_cpcl)과 MLM+CPCL 조합 효과 비교
#       circRNA-specific CPCL이 MLM 위에서도 효과적인지 검증
#
# Usage: ./scripts/v2_missing/run_new_g1_mlm_cpcl.sh [GPU_ID]
#===============================================================================
set -e
...
# ── Finetuning ────────────────────────────────────────────────────────────────
echo ""
echo "━━━ Finetuning: v2_pt_mlm_cpcl s1,2,3 ━━━"
