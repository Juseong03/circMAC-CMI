#!/bin/bash
#===============================================================================
# Missing Experiments — Server1 GPU 2
#
# EXP2: v2_pt_cpcl  (MLM + CPCL × 3 seeds)
#   Pretrain: v2_ptm_cpcl  (--mlm --cpcl, seed=42)
#   Finetune: v2_pt_cpcl_s1, _s2, _s3
#
# Usage: ./scripts/v2_missing/run_missing_s1g2.sh [GPU_ID]
#===============================================================================
set -e
...
# ══ v2_pt_cpcl: MLM + CPCL ═══════════════════════════════════════════════════
echo ""
echo "━━━ v2_pt_cpcl: MLM + Circular Permutation Contrastive Learning ━━━"
run_pretrain "cpcl" --mlm --cpcl
PT_PATH="saved_models/circmac/v2_ptm_cpcl/${PT_SEED}/pretrain/model.pth"
if [ -f "$PT_PATH" ]; then
    run_finetune "cpcl" "$PT_PATH"
else
