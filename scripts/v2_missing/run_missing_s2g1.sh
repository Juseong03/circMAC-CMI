#!/bin/bash
#===============================================================================
# Missing Experiments — Server2 GPU 1
#
# EXP2: v2_pt_all  (MLM+NTP+SSP+Pairing+CPCL+BSJ_MLM × 3 seeds)
#   Pretrain: v2_ptm_all  (all tasks, seed=42)
#   Finetune: v2_pt_all_s1, _s2, _s3
#
# Note: longest script (~16h) due to all pretraining tasks combined
#
# Usage: ./scripts/v2_missing/run_missing_s2g1.sh [GPU_ID]
#===============================================================================
set -e
...
echo "  EXP2: v2_pt_all  (All pretraining tasks)"
