#!/bin/bash
# SUB438 — RNABERT frozen, seeds 1 2 3
# Usage: ./scripts/sub438/rnabert_frozen.sh [GPU_ID]
set -e
GPU=${1:-0}; MODEL="rnabert"; MAX_LEN=438; BS=128; PREFIX="sub438"
LR=1e-4; EPOCHS=150; EARLYSTOP=20; NUM_WORKERS=4; D_MODEL=128; N_LAYER=6

mkdir -p "logs/${PREFIX}" saved_models
TOTAL=0; SKIPPED=0; RAN=0
echo "=== SUB438 ${MODEL} frozen (GPU $GPU) ==="
