#!/bin/bash
#===============================================================================
# Experiment 2 - SS5: 5x Stochastic Secondary Structure
# Pretrain with df_circ_ss_5 (5 SS per RNA) + Fine-tune + No-pretrain baseline
#
# Runs: 39 (9 pretrain + 27 finetune + 3 baseline)
# Usage: ./scripts/2gpu/exp2_ss5.sh [GPU_ID]
#===============================================================================
...
echo "=============================================="
echo "  Exp2 SS5: Pretrain + Fine-tune (df_circ_ss_5)"
echo "  GPU: $GPU | Runs: 39"
echo "=============================================="
...
# Run first while pretrain is not yet needed
#-----------------------------------------------
echo ""
...
#-----------------------------------------------
# Phase 2: Fine-tuning with ss5 pretrained models (27 runs)
#-----------------------------------------------
echo ""
...
echo ""
echo "=============================================="
echo "  Exp2 SS5 Complete! [39 runs]"
echo "=============================================="
