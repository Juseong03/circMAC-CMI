#!/bin/bash
# SUB438 ISO-DISJOINT — RNAErnie fine-tuned, seeds 1 2 3
# Usage: bash scripts/sub438_iso/rnaernie_ft.sh [GPU_ID]
set -e
GPU=${1:-1}
MODEL="rnaernie"; MAX_LEN=438; BS=32; PREFIX="sub438_iso"
...
echo "=== SUB438-ISO ${MODEL} fine-tuned (GPU=$GPU) ==="
