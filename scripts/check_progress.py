...
EXPERIMENTS = [
    ...
    ("pretraining", "MLM+Pairing", "circmac", "v2_pt_mlm_pairing", "pt"),
    ("pretraining", "SSP+Pairing", "circmac", "v2_pt_ssp_pairing", "pt"),
    ("pretraining", "MLM+NTP+SSP", "circmac", "v2_pt_mlm_ntp_ssp", "pt"),
    ...
    ("iso_disjoint", "CircMAC (MLM+Pairing)", "circmac", "iso_pt_mlm_pairing", None),
    ("iso_disjoint", "CircMAC (SSP+Pairing)", "circmac", "iso_pt_ssp_pairing", None),
    ("iso_disjoint", "CircMAC (MLM+NTP+SSP)", "circmac", "iso_pt_mlm_ntp_ssp", None),
    ...
    ("bsj_disjoint", "CircMAC (MLM+Pairing)", "circmac", "bsj_pt_mlm_pairing", None),
    ("bsj_disjoint", "CircMAC (SSP+Pairing)", "circmac", "bsj_pt_ssp_pairing", None),
    ("bsj_disjoint", "CircMAC (MLM+NTP+SSP)", "circmac", "bsj_pt_mlm_ntp_ssp", None),
...
PRETRAIN_STRATEGIES = [
    ...
    ("ssp_pairing", "--ssp --pairing"),
    ("mlm_ntp_ssp", "--mlm --ntp --ssp"),
    ("all",         "--mlm --ntp --ssp --pairing"),
]
