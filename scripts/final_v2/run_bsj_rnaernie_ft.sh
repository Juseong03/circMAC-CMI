#!/bin/bash
# Train rnaernie on BSJ-DISJOINT x 3 seeds
# Usage: bash scripts/final_v2/run_bsj_rnaernie_ft.sh <GPU>
...
echo "=== BSJ-DISJOINT rnaernie (GPU=$GPU seeds=${SEEDS[*]}) ==="

for SEED in "${SEEDS[@]}"; do
    EXP="bsj_rnaernie_ft_s${SEED}"
...
echo "=== BSJ-DISJOINT rnaernie done ==="
