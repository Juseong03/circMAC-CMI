#!/bin/bash
# Train rnamsm on ISO-DISJOINT x 3 seeds
# Usage: bash scripts/final_v2/run_iso_rnamsm_ft.sh <GPU>
...
echo "=== ISO-DISJOINT rnamsm (GPU=$GPU seeds=${SEEDS[*]}) ==="

for SEED in "${SEEDS[@]}"; do
    EXP="iso_rnamsm_ft_s${SEED}"
