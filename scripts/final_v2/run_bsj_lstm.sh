#!/bin/bash
# Train lstm on BSJ-DISJOINT x 3 seeds
# Usage: bash scripts/final_v2/run_bsj_lstm.sh <GPU>
...
echo "=== BSJ-DISJOINT lstm (GPU=$GPU seeds=${SEEDS[*]}) ==="
