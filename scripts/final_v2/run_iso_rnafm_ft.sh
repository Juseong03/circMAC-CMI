#!/bin/bash
# Train rnafm on ISO-DISJOINT x 3 seeds
# Usage: bash scripts/final_v2/run_iso_rnafm_ft.sh <GPU>
...
echo "=== ISO-DISJOINT rnafm (GPU=$GPU seeds=${SEEDS[*]}) ==="

for SEED in "${SEEDS[@]}"; do
    EXP="iso_rnafm_ft_s${SEED}"
