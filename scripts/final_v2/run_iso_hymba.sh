#!/bin/bash
# Train hymba on ISO-DISJOINT x 3 seeds
# Usage: bash scripts/final_v2/run_iso_hymba.sh <GPU>
...
echo "=== ISO-DISJOINT hymba (GPU=$GPU seeds=${SEEDS[*]}) ==="

for SEED in "${SEEDS[@]}"; do
    EXP="iso_hymba_s${SEED}"
