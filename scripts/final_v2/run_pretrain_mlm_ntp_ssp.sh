#!/bin/bash
#===============================================================================
# Pretraining: MLM + NTP + SSP  (pair split finetune)
# = All without Pairing → isolates Pairing's contribution
#
# Step 1: Pretrain circmac  → saved_models/circmac/v2_ptm_mlm_ntp_ssp/42/pretrain/model.pth
# Step 2: Finetune × seeds  → saved_models/circmac/v2_pt_mlm_ntp_ssp_s{seed}/
#
# Usage: bash scripts/final_v2/run_pretrain_mlm_ntp_ssp.sh <GPU>
# SEEDS_OVERRIDE="1 2 3" bash scripts/final_v2/run_pretrain_mlm_ntp_ssp.sh <GPU>
#===============================================================================
set -e
...
echo "=== Pretrain: MLM+NTP+SSP → Finetune (GPU=$GPU seeds=${SEEDS[*]}) ==="

# ── Step 1: Pretraining ────────────────────────────────────────────────────────
PT_EXP="v2_ptm_mlm_ntp_ssp"
