#!/bin/bash
# CircMAC (NoPT) — iso + bsj, batch_size=64, seed=1
# Usage: bash scripts/final_v2/bs64_s1/run_circmac_nopt.sh <GPU>
...
for SPLIT in iso bsj; do
    ...
    EXP="${SPLIT}_pt_nopt_bs64_s${SEED}"
...
echo "=== circmac_nopt bs64 s1 done ==="
