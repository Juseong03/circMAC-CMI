#!/bin/bash
# Transformer — iso + bsj, batch_size=64, seed=1
# Usage: bash scripts/final_v2/bs64_s1/run_transformer.sh <GPU>
...
for SPLIT in iso bsj; do
    ...
    EXP="${SPLIT}_transformer_bs64_s${SEED}"
