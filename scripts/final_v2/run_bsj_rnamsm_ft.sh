#!/bin/bash
# Train rnamsm on BSJ-DISJOINT x 3 seeds
# Usage: bash scripts/final_v2/run_bsj_rnamsm_ft.sh <GPU>
...
echo "=== BSJ-DISJOINT rnamsm (GPU=$GPU seeds=${SEEDS[*]}) ==="

for SEED in "${SEEDS[@]}"; do
    EXP="bsj_rnamsm_ft_s${SEED}"
