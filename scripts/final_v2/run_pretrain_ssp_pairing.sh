#!/bin/bash
#===============================================================================
# Pretraining: SSP + Pairing  (pair split finetune)
#
# Step 1: Pretrain circmac  → saved_models/circmac/v2_ptm_ssp_pairing/42/pretrain/model.pth
# Step 2: Finetune × seeds  → saved_models/circmac/v2_pt_ssp_pairing_s{seed}/
#
# Usage: bash scripts/final_v2/run_pretrain_ssp_pairing.sh <GPU>
# SEEDS_OVERRIDE="1 2 3" bash scripts/final_v2/run_pretrain_ssp_pairing.sh <GPU>
#===============================================================================
set -e
...
echo "=== Pretrain: SSP+Pairing → Finetune (GPU=$GPU seeds=${SEEDS[*]}) ==="

# ── Step 1: Pretraining ────────────────────────────────────────────────────────
PT_EXP="v2_ptm_ssp_pairing"
