#!/bin/bash
# Train rnaernie on ISO-DISJOINT x 3 seeds
# Usage: bash scripts/final_v2/run_iso_rnaernie_ft.sh <GPU>
...
echo "=== ISO-DISJOINT rnaernie (GPU=$GPU seeds=${SEEDS[*]}) ==="

for SEED in "${SEEDS[@]}"; do
    EXP="iso_rnaernie_ft_s${SEED}"
...
echo "=== ISO-DISJOINT rnaernie done ==="
