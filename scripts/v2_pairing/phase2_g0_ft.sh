#!/bin/bash
#===============================================================================
# Phase 2 — GPU 0: Finetune seeds 1,2,3 for  v2_ptm_mlm_cpcl_pairing
#
# Requires Phase 1 GPU 0 to be complete.
# Run in PARALLEL with phase2_g1_ft.sh.
#
# Experiments:
#   v2_pt_mlm_cpcl_pairing_s1
#   v2_pt_mlm_cpcl_pairing_s2
#   v2_pt_mlm_cpcl_pairing_s3
#
# Usage: ./scripts/v2_pairing/phase2_g0_ft.sh [GPU_ID]
#===============================================================================
set -e
...
if [ ! -f "$PT_PATH" ]; then
    ...
    echo "       Run phase1_g0_pt.sh first."
    exit 1
fi
