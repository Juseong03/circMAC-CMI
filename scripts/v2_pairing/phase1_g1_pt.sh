#!/bin/bash
#===============================================================================
# Phase 1 — GPU 1: Pretrain  v2_ptm_mlm_cpcl_ssp_pairing
#                            (--mlm --cpcl --ssp --pairing)
#
# Run in PARALLEL with phase1_g0_pt.sh (mlm_cpcl_pairing on GPU 0).
# After both finish, run phase2_g0_ft.sh and phase2_g1_ft.sh.
#
# Usage: ./scripts/v2_pairing/phase1_g1_pt.sh [GPU_ID]
#===============================================================================
set -e
...
echo "  Flags: --mlm --cpcl --ssp --pairing"
echo "  Data: $PT_DATA"
...
echo "  Now run: ./scripts/v2_pairing/phase2_g1_ft.sh $GPU"
