#!/bin/bash
# SUB511 ISO-DISJOINT — RNAErnie fine-tuned, seeds 1 2 3
# Usage: bash scripts/sub511_iso/rnaernie_ft.sh [GPU_ID]
set -e
GPU=${1:-0}
MODEL="rnaernie"; MAX_LEN=511; BS=32; PREFIX="sub511_iso"
...
echo "=== SUB511-ISO ${MODEL} fine-tuned (GPU=$GPU) ==="
