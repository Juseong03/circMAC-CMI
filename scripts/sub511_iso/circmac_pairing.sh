#!/bin/bash
# SUB511 ISO-DISJOINT — CircMAC + Pairing pretrained, seeds 1 2 3
# Usage: bash scripts/sub511_iso/circmac_pairing.sh [GPU_ID]
set -e
GPU=${1:-3}
MODEL="circmac"; MAX_LEN=511; BS=128; PREFIX="sub511_iso"
...
echo "=== SUB511-ISO ${MODEL} pairing-pretrained (GPU=$GPU) ==="
