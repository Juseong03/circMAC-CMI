#!/bin/bash
#===============================================================================
# PT: v2_ptm_mlm_cpcl_pairing_ssp  (--mlm --cpcl --pairing --ssp)
#
# Usage: ./scripts/v2_new_pt/pt_mlm_cpcl_pairing_ssp.sh [GPU_ID]
#===============================================================================
set -e

GPU=${1:-0}
PT_EXP="v2_ptm_mlm_cpcl_pairing_ssp"
PT_SEED=42
...
echo "  Flags: --mlm --cpcl --pairing --ssp"
