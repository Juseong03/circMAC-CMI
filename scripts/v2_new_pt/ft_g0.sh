...
#===============================================================================
# FT GPU 0 — seed 1
#   1. v2_pt_mlm_cpcl_pairing_s1     ← v2_ptm_mlm_cpcl_pairing
#   2. v2_pt_mlm_cpcl_pairing_ssp_s1 ← v2_ptm_mlm_cpcl_pairing_ssp
#
# Run AFTER all 3 PT scripts complete.
# Usage: ./scripts/v2_new_pt/ft_g0.sh [GPU_ID]
#===============================================================================
set -e
