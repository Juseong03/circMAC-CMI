#!/bin/bash
# SUB438 BSJ-DISJOINT — RNAErnie fine-tuned, seeds 1 2 3
# Usage: bash scripts/sub438_bsj/rnaernie_ft.sh [GPU_ID]
set -e
GPU=${1:-1}
MODEL="rnaernie"; MAX_LEN=438; BS=32; PREFIX="sub438_bsj"
...
echo "=== SUB438-BSJ ${MODEL} fine-tuned (GPU=$GPU) ==="
