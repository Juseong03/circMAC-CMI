#!/bin/bash
# MAX — RNAMSM fine-tuned BS=32, seeds 1 2 3
# Usage: ./scripts/max/gpu1_rnamsm_ft.sh [GPU_ID]
set -e
GPU=${1:-1}; MODEL="rnamsm"; MAX_LEN=1022; BS=32; PREFIX="max"
LR=1e-4; EPOCHS=150; EARLYSTOP=20; NUM_WORKERS=4; D_MODEL=128; N_LAYER=6

mkdir -p "logs/${PREFIX}" saved_models
TOTAL=0; SKIPPED=0; RAN=0
echo "=== MAX ${MODEL} fine-tuned (GPU $GPU) ==="
