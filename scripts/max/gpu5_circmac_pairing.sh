#!/bin/bash
# MAX — CircMAC + pairing pretrained, seeds 1 2 3
# Usage: ./scripts/max/gpu5_circmac_pairing.sh [GPU_ID]
set -e
GPU=${1:-5}; MODEL="circmac"; MAX_LEN=1022; BS=128; PREFIX="max"
...
echo "=== MAX ${MODEL} pairing-pretrained (GPU $GPU) ==="
