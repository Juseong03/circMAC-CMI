#!/bin/bash
#===============================================================================
# NEW Exp2v2 - Server3-GPU1
# Config: MLM_NTP_CPCL_PAIR
# Runs: 1 pretrain + 3 finetune = 4
#===============================================================================
set -e
GPU=${1:-1}
SEEDS=(1 2 3)
...
CONFIG_NAME="mlm_ntp_cpcl_pair"
CONFIG_FLAGS="--mlm --ntp --cpcl --pairing"

echo "=== Exp2v2 Server3-GPU1: MLM_NTP_CPCL_PAIR ==="
