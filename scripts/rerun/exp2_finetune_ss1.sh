...
# Pretraining configurations (same as exp2_ss1.sh)
...
echo "=============================================="
echo "  RERUN: Exp2 SS1 Fine-tune Only"
echo "  GPU: $GPU"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "  RERUN Complete: Exp2 SS1 Fine-tune"
