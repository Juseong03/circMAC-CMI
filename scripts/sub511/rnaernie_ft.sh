#!/bin/bash
# SUB511 — RNAErnie fine-tuned BS=32, seeds 1 2 3  (native max=511)
# Usage: ./scripts/sub511/rnaernie_ft.sh [GPU_ID]
set -e
GPU=${1:-0}; MODEL="rnaernie"; MAX_LEN=511; BS=32; PREFIX="sub511"
